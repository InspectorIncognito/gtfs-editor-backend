...
from user.views import UserLoginView, UserRegisterView, UserConfirmationEmailView, UserRecoverPasswordRequestView
...
urlpatterns = [
    ...
    path('user/recover-password', UserRecoverPasswordRequestView.as_view(), name='recover-password'),
